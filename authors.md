...
Source:
[`DESCRIPTION`](https://github.com/StrategicProjects/raisr/blob/main/DESCRIPTION)

Leite A, Wasiliew M, Vasconcelos H, Amorim C, Bezerra D, Nascimento
Barreto J (2026). *raisr: Access 'RAIS' Microdata from the Brazilian
Ministry of Labour*. R package version 0.1.0,
<https://github.com/StrategicProjects/raisr>.

    @Manual{,
      title = {raisr: Access 'RAIS' Microdata from the Brazilian Ministry of Labour},
      ...
      url = {https://github.com/StrategicProjects/raisr},
    }
